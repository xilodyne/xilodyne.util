package xilodyne.util.python.pyplot;
...
public class ScatterPlot {
	...
	private Logger log = new Logger("SP");
	 ...
	 */
	public ScatterPlot(String chartName, String xAxis, String yAxis) {	
		log.logln_withClassName(Logger.LOG_FINE, "Creating chart [" + chartName +"]");
		this.initChar(chartName, xAxis, yAxis);
	}
	...
	private void initChar(String chartName, String xAxis, String yAxis) {
	...
	private JFreeChart createChart(String chartName, String xAxis, String yAxis) {
		...
		chart.getXYPlot().setRenderer(ScatterPlot.REND_FRONTIER, renderFrontier);
		chart.getXYPlot().setRenderer(ScatterPlot.REND_DATA, renderData);
	...
	public void addFrontier(double[][] frontier, Color cOne, Color cTwo) {
		log.logln(Logger.lF, "Creating frontier.");
		...
		log.logln_withClassName(Logger.lD, "Dot size x,y: " + dotSizeWidth + "," + dotSizeHeight);
		...
		plot0.setDataset(ScatterPlot.REND_FRONTIER, boundaryDataset);
	...
	public void scatter(String name, double[] x, double[] y, Color color) {
		log.logln(Logger.lF, "Creating series [" + name +"]");
		...
		plot1.setDataset(ScatterPlot.REND_DATA, this.graphDataSet);

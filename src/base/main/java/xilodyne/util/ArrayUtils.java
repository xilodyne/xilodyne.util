...
/**
 * Routines for working with arrays and NDArray
 * 
...
//				sb.append(String.format("%.1f", array[x]) + "  ");
	 ...
	 * @return String
	 */
	public static String printArray(Hashtable<String, String> array) {
		StringBuffer sb = new StringBuffer();
		Set<String> keys = array.keySet();
		int lineBreak = 0;

		for (String key : keys) {
			sb.append("[" + key +":"+ array.get(key) + "] ");
				if (lineBreak > 13) {
					sb.append("\n");
					lineBreak = 0;
				} else {
	 ...
	 * @return String ['value...','value...','value ...]
	 */	
	public static String printListFloat(List<Float> list) {
		StringBuffer sb = new StringBuffer();
		sb.append("[");
		if (list == null) {
			System.out.println(" null list ");
	 ...
	 * @return String ['value...','value...','value ...]
	 */	
	public static String printListDouble(ArrayList<Double> list) {
		StringBuffer sb = new StringBuffer();
		sb.append("[");
		if (list == null) {
			System.out.println(" null list ");
